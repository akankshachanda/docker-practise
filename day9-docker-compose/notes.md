...
- You now have every skill needed to deploy a real app

Next up → [**Day 10: Capstone Projects**](../day10-capstone/notes.md) - deploy this app to a live AWS EC2 server, then harden it to production grade.
