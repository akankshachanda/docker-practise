...
flowchart LR
    ...
    D8 --> D9["Day 9<br/>Compose"] --> D10["Day 10<br/>Capstone"]
    style D1 fill:#0277bd,color:#fff
    style D10 fill:#2e7d32,color:#fff
```
...
| 10 | [Capstone Projects](day10-capstone/notes.md) | Deploy the app to a live AWS EC2 server; then harden it to production grade |
